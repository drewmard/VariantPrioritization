...
dir.create("/oak/stanford/groups/smontgom/amarder/VariantPrioritization/out/finemap/all")
...
# for (j in 1:1) { 
  if (j==1) {
    headdir = paste0("/oak/stanford/groups/smontgom/amarder/VariantPrioritization/out/finemap/",trait,"/SUSIE/window.L_10/")
  } else if (j==2) {
    headdir = paste0("/oak/stanford/groups/smontgom/amarder/VariantPrioritization/out/finemap/",trait,"/SUSIE/window.L_1/")
  } 
...
f.out = paste0("/oak/stanford/groups/smontgom/amarder/VariantPrioritization/out/finemap/all/",trait,".susie_all.txt")
fwrite(finemap.mg2,f.out,quote = F,na = "NA",sep = '\t',row.names = F,col.names = T)
